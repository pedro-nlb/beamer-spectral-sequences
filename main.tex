...
\begin{frame}
    \frametitle{Baby example: 2 step filtration on a length 1 complex}
    \adjustbox{scale=1.2,center}{%
	\begin{tikzcd}[ampersand replacement=\&]
	    C=F^{0}C \&[-20pt] \cdots\arrow{r} \&[-15pt] 0\arrow{r} \&[-15pt] C^{0}\arrow{r}{d^{0}} \arrow{r} \&[10pt] C^{1}\arrow{r} \&[-15pt] 0\arrow{r} \&[-15pt] \cdots \\
	    ...
	    0=F^{2}C\arrow[draw=none]{u}[sloped,auto=false]{\subseteq} \& \cdots\arrow{r} \& 0 \arrow{r} \& 0\arrow[draw=none]{u}[sloped,auto=false]{\subseteq}\arrow{r} \& 0\arrow[draw=none]{u}[sloped,auto=false]{\subseteq}\arrow{r}\& 0 \arrow{r} \&[-15pt]\cdots
	\end{tikzcd}
    }
\end{frame}

\begin{frame}
    \frametitle{Baby example: filtration induced in cohomology}
    \adjustbox{scale=1.2,center}{%
	\begin{tikzcd}[ampersand replacement=\&]
    ...
    \pause
    \vspace{3em}
    \[ \Rightarrow F^{1}H=\ker\left(d^{0}|_{F^{1}C}\right)[0]\op \left(\frac{F^{1}C^{1}+\im(d^{0})}{\im(d^{0})}\right)[-1] \]
\end{frame}
